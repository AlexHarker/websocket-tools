 ...
 *
 * This class serves as a base for WebSocket client implementations, inheriting from `ws_base`.
 * It provides a static method to create a WebSocket client instance.
 *
...
public:
     ...
     *
     * This static method creates and returns a WebSocket client instance by delegating
     * to the `ws_base` class's `create` method.
     *

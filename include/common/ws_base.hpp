 ...
 *
 * This type is used to represent WebSocket connection IDs using a pointer type (uintptr_t).
 */
 ...
 *
 * This function takes a pointer and casts it to a ws_connection_id (uintptr_t) type.
 *
 ...
 *
 * This templated class serves as a base for both WebSocket clients and servers, providing shared 
 * functionality like object creation.
 *
...
protected:
     ...
     *
     * This method allocates a new object of type T and checks if the handle is valid. If the handle is not valid,
     * the object is deleted and null is returned.
     *
     ...
     *
     * This member holds the handle for the WebSocket, which mihgt be specific to either a client or a server.
     */
